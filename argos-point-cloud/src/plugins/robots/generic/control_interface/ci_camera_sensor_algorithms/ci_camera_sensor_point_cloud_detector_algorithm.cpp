/**
 * @file <argos3/plugins/robots/generic/control_interface/ci_camera_sensor_algorithms/ci_camera_sensor_point_cloud_detector_algorithm.cpp>
 *
 * @author Nathalie Majcherczyk - <nmajcherczyk@wpi.edu>
 */

#include "ci_camera_sensor_point_cloud_detector_algorithm.h"
...
#ifdef ARGOS_WITH_LUA
   void CCI_CameraSensorPointCloudDetectorAlgorithm::CreateLuaState(lua_State* pt_lua_state) {
      for(size_t i = 0; i < m_vecReadings.size(); ++i) {
         CLuaUtility::StartTable(pt_lua_state, i + 1);
         CLuaUtility::AddToTable(pt_lua_state, "category", m_vecReadings[i].Category);
...
#ifdef ARGOS_WITH_LUA
   void CCI_CameraSensorPointCloudDetectorAlgorithm::ReadingsToLuaState(lua_State* pt_lua_state) {
